...
hand_joints_goal_1 = {'rh_FFJ1': 0.3438351595450134, 'rh_FFJ2': 1.0716025788727896, 'rh_FFJ3': 0.44917149949781676,
...
hand_joints_goal_2 = {'rh_FFJ1': 0.20499011244971338, 'rh_FFJ2': 1.2075734473544302, 'rh_FFJ3': 1.0,
...
for x in range(0, 3):
    ...
    hand_commander.move_to_joint_value_target_unsafe(joint_goals, 1.0, True)
    rospy.sleep(1)
    joint_goals = hand_joints_goal_2
    rospy.loginfo("Moving hand to joint states\n" + str(joint_goals) + "\n")
    hand_commander.move_to_joint_value_target_unsafe(joint_goals, 0.5, True)
    rospy.sleep(0.5)
