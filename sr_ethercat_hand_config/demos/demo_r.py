...
# flex thumb step 1
flex_th_1 = {"rh_THJ1": 0, "rh_THJ2": 0, "rh_THJ3": 0, "rh_THJ4": 70, "rh_THJ5": 25}
# flex thumb step 2
...
bc_zero = {"rh_THJ1": 38, "rh_THJ2": 4, "rh_THJ3": 0, "rh_THJ4": 47, "rh_THJ5": -11,
           "rh_MFJ1": 7, "rh_MFJ2": 64, "rh_MFJ3": 24, "rh_MFJ4": 20}
# business card position 1 
bc_1 = {"rh_FFJ1": 47, "rh_FFJ2": 90, "rh_FFJ3": 7}
# business card position 2 
bc_2 = {"rh_FFJ1": 47, "rh_FFJ2": 90, "rh_FFJ3": 63}
# business card position 3 
bc_3 = {"rh_FFJ1": 0, "rh_FFJ2": 60, "rh_FFJ3": 63}
# business card position 4 
bc_4 = {"rh_FFJ1": 90, "rh_FFJ2": 90, "rh_FFJ3": 63, "rh_FFJ4": 16}
...
#    rospy.sleep(1)
    ...
    rospy.sleep(0.7)
    hand_commander.move_to_joint_value_target_unsafe(flex_th_2, 1.5, False, angle_degrees=True)
    rospy.sleep(2.0)
