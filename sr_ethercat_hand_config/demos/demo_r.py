...
ff_ok = {"rh_THJ1": 15, "rh_THJ2": 20, "rh_THJ3": 0, "rh_THJ4": 62, "rh_THJ5": 18,
...
mf_ok = {"rh_THJ1": 15, "rh_THJ2": 17, "rh_THJ3": 8, "rh_THJ4": 68, "rh_THJ5": 31,
         "rh_FFJ1": 0, "rh_FFJ2": 14, "rh_FFJ3": 7, "rh_FFJ4": -0.4,
...
def secuence_ff():
    ...
    rospy.sleep(1.2)
    hand_commander.move_to_joint_value_target_unsafe(flex_ff, 1.1, False, angle_degrees=True)
    rospy.sleep(1.4)
    hand_commander.move_to_joint_value_target_unsafe(ext_ff, 1.1, False, angle_degrees=True)
    rospy.sleep(1.4)
    hand_commander.move_to_joint_value_target_unsafe(flex_mf, 1.1, False, angle_degrees=True)
    rospy.sleep(1.4)
    hand_commander.move_to_joint_value_target_unsafe(ext_mf, 1.1, False, angle_degrees=True)
    rospy.sleep(1.4)
    hand_commander.move_to_joint_value_target_unsafe(flex_rf, 1.1, False, angle_degrees=True)
    rospy.sleep(1.4)
    hand_commander.move_to_joint_value_target_unsafe(ext_rf, 1.1, False, angle_degrees=True)
    rospy.sleep(1.4)
    hand_commander.move_to_joint_value_target_unsafe(flex_lf, 1.1, False, angle_degrees=True)
    rospy.sleep(1.4)
    hand_commander.move_to_joint_value_target_unsafe(ext_lf, 1.1, False, angle_degrees=True)
    rospy.sleep(1.4)
    hand_commander.move_to_joint_value_target_unsafe(flex_th_1, 0.7, False, angle_degrees=True)
    rospy.sleep(0.7)
    hand_commander.move_to_joint_value_target_unsafe(flex_th_2, 1.2, False, angle_degrees=True)
    rospy.sleep(1.5)
