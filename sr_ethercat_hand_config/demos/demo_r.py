...
class FancyDemo(object):
    ...
    ff_ok = [ joint(joint_name ="rh_FFJ0", joint_target = 94),
    ...
    rf_ok = [ joint(joint_name ="rh_FFJ0", joint_target = 13.6),
	          ...
	          joint(joint_name ="rh_MFJ3", joint_target = 3.7),
	          joint(joint_name ="rh_MFJ4", joint_target = -1),
	          joint(joint_name ="rh_RFJ0", joint_target = 108),
	          joint(joint_name ="rh_RFJ3", joint_target = 34),
	          ...
	          joint(joint_name ="rh_THJ4", joint_target = 70),
	          joint(joint_name ="rh_THJ5", joint_target = 37) ]
 ...
 # store step 1 Bio_Tac
    ...
    def create_hand_publishers(self):
        ...
        for joint in ["rh_FFJ0", "rh_FFJ3", "rh_FFJ4",
                      ...
                      "rh_WRJ1", "rh_WRJ2" ]:
            hand_pub[joint] = rospy.Publisher('sh_'+joint.lower()+'_position_controller/command', Float64, latch=True, queue_size=1)
