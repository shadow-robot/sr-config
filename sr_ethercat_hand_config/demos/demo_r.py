...
min_range = {"THJ1": 0, "THJ2": -40, "THJ3": -12, "THJ4": 0, "THJ5": -55,
...
max_range = {"THJ1": 40, "THJ2": 20, "THJ3": 12, "THJ4": 70, "THJ5": 0,
...
grasp_pos = {"THJ1": 20, "THJ2": 35, "THJ3": 15, "THJ4": 69, "THJ5": -3,
...
rand_pos = {"THJ1": 0, "THJ2": 0, "THJ3": 0, "THJ4": 0, "THJ5": 0,
	    "FFJ0": 0, "FFJ3": 0, "FFJ4": 0,
	    "MFJ0": 0, "MFJ3": 0, "MFJ4": 0,
	    "RFJ0": 0, "RFJ3": 0, "RFJ4": 0,
	    "LFJ0": 0, "LFJ3": 0, "LFJ4": 0, "LFJ5": 0,
...
# flex thumb step 2
flex_th_2 = {"THJ1": 40, "THJ2": 40, "THJ3": 10, "THJ4": 70, "THJ5": 60 }
# extend thumb step 1
...
pre_ff_ok = {"THJ4": 70, "THJ5": 10 }
# O.K. with first finger
ff_ok = {"THJ1": 6, "THJ2": 34, "THJ3": -12, "THJ4": 58, "THJ5": 28,
	 "FFJ0": 80, "FFJ3": 45, "FFJ4": 14,
...
mf2rf_ok = {"THJ1": 5, "THJ2": -5, "THJ3": 15, "THJ4": 70, "THJ5": 29,
	    "FFJ0": 14, "FFJ3": 7, "FFJ4": -0.4,
	    "MFJ0": 45, "MFJ3": 4, "MFJ4": -1,
	    "RFJ0": 50, "RFJ3": 8, "RFJ4": -10,
	    "LFJ0": 30, "LFJ3": 0, "LFJ4": -12, "LFJ5": 7 }
# O.K. with ring finger
rf_ok = {"THJ1": 0, "THJ2": 30, "THJ3": 15, "THJ4": 70, "THJ5": 44,
	 "FFJ0": 14, "FFJ3": 7, "FFJ4": -0.4,
	 "MFJ0": 45, "MFJ3": 4, "MFJ4": -1,
	 "RFJ0": 91, "RFJ3": 45, "RFJ4": -19,
	 "LFJ0": 30, "LFJ3": 0, "LFJ4": -12, "LFJ5": 7 }
...
def secuence_rf():
   ...
   while True:
      ...
      if ( tactile_values['FF'] > force_zero['FF'] and trigger[0] == 0 ):
         c.move_hand({"FFJ0": hand_pos['FFJ0'] + offset1, "FFJ3": hand_pos['FFJ3'] + offset2})
         print 'First finger contact'
         trigger[0] = 1

      if ( tactile_values['MF'] > force_zero['MF'] and trigger[1] == 0 ):
         c.move_hand({"MFJ0": hand_pos['MFJ0'] + offset1, "MFJ3": hand_pos['MFJ3'] + offset2})
         print 'Middle finger contact'
         trigger[1] = 1

      if ( tactile_values['RF'] > force_zero['RF'] and trigger[2] == 0 ):
         c.move_hand({"RFJ0": hand_pos['RFJ0'] + offset1, "RFJ3": hand_pos['RFJ3'] + offset2})
         print 'Ring finger contact'
         trigger[2] = 1

      if ( tactile_values['LF'] > force_zero['LF'] and trigger[3] == 0 ):
         c.move_hand({"LFJ0": hand_pos['LFJ0'] + offset1, "LFJ3": hand_pos['LFJ3'] + offset2})
         print 'Little finger contact'
         trigger[3] = 1

      if ( tactile_values['TH'] > force_zero['TH'] and trigger[4] == 0 ):
         c.move_hand({"THJ2": hand_pos['THJ2'] + offset1, "THJ5": hand_pos['THJ5'] + offset2 })
         print 'Thumb contact'
         trigger[4] = 1
   ...
   squeeze.update({"THJ5": hand_pos['THJ5'] + offset3, "THJ2": hand_pos['THJ2'] + offset3,
		   "FFJ3": hand_pos['FFJ3'] + offset3, "FFJ0": hand_pos['FFJ0'] + offset3,
   		  # "MFJ3": hand_pos['MFJ3'] + offset3, "MFJ0": hand_pos['MFJ0'] + offset3,
		   "RFJ3": hand_pos['RFJ3'] + offset3, "RFJ0": hand_pos['RFJ0'] + offset2})
		  # "LFJ3": hand_pos['LFJ3'] + offset3, "LFJ0": hand_pos['LFJ0'] + offset3})
...
def zero_tactile_sensors():
   ...
   force_zero['FF'] = force_zero['FF'] + 2
   force_zero['MF'] = force_zero['MF'] + 2
   force_zero['RF'] = force_zero['RF'] + 2
   force_zero['LF'] = force_zero['LF'] + 2
   force_zero['TH'] = force_zero['TH'] + 2
...
#   print "   MF: Open Hand Demo"
   print "   RF: Grasp Demo"
#   print "   LF: Handshake Demo"
   print "   TH: Shy Hand Demo"
