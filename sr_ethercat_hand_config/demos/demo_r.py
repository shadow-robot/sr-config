...
start_pos = {"rh_THJ1": 0, "rh_THJ2": 0, "rh_THJ3": 0, "rh_THJ4": 0, "rh_THJ5": 0,
             ...
             "rh_LFJ1": 0, "rh_LFJ2": 0, "rh_LFJ3": 0, "rh_LFJ4": -8, "rh_LFJ5": 0,
             "rh_WRJ1": 0, "rh_WRJ2": 0}
...
rand_pos = {"rh_THJ2": 0, "rh_THJ3": 0, "rh_THJ4": 0, "rh_THJ5": 0,
            ...
            "rh_LFJ1": 0, "rh_LFJ2": 0, "rh_LFJ3": 0, "rh_LFJ4": -10, "rh_LFJ5": 0,
            "rh_WRJ1": 0, "rh_WRJ2": 0}
# flex first finger
...
# extend middle finger
ext_lf = {"rh_LFJ1": 0, "rh_LFJ2": 0, "rh_LFJ3": 0, "rh_LFJ4": -10}
# flex thumb step 1
...
ff_ok = {"rh_THJ1": 15, "rh_THJ2": 20, "rh_THJ3": 0, "rh_THJ4": 56, "rh_THJ5": 18,
         ...
         "rh_LFJ1": 0, "rh_LFJ2": 30, "rh_LFJ3": 0, "rh_LFJ4": -8, "rh_LFJ5": 7}
...
rf_ok = {"rh_THJ1": 13, "rh_THJ2": 33, "rh_THJ3": 12, "rh_THJ4": 70, "rh_THJ5": 37,
...
lf_ok = {"rh_THJ1": 6, "rh_THJ2": 11, "rh_THJ3": 10, "rh_THJ4": 69, "rh_THJ5": 30,
         "rh_FFJ1": 0, "rh_FFJ2": 14, "rh_FFJ3": 7, "rh_FFJ4": -7,
         "rh_MFJ1": 0, "rh_MFJ2": 15, "rh_MFJ3": 4, "rh_MFJ4": -3,
         "rh_RFJ1": 0, "rh_RFJ2": 15, "rh_RFJ3": 6, "rh_RFJ4": -1,
         "rh_LFJ1": 0, "rh_LFJ2": 76, "rh_LFJ3": 12, "rh_LFJ4": 6, "rh_LFJ5": 44}
# zero wrist
...
l_int_lf = {"rh_LFJ4": 15}
# all zero
l_zero_all = {"rh_FFJ4": -6, "rh_MFJ4": -3, "rh_RFJ4": -3, "rh_LFJ4": -6}
# spock
...
def secuence_ff():
    ...
    rospy.sleep(2)
    hand_commander.move_to_joint_value_target_unsafe(flex_lf, 2.0, False, angle_degrees=True)
    rospy.sleep(2)
    hand_commander.move_to_joint_value_target_unsafe(ext_lf, 2.0, False, angle_degrees=True)
    rospy.sleep(2)
