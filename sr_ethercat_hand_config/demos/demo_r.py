...
# flex thumb step 2
flex_th_2 = {"THJ1": 17, "THJ2": 40, "THJ3": 0, "THJ4": 70, "THJ5": 60 }
# extend thumb step 1
...
ff_ok = {"THJ1": 14, "THJ2": 20, "THJ3": 0, "THJ4": 54, "THJ5": 21,
            "FFJ0": 65, "FFJ3": 52, "FFJ4": -0.2,
...
mf_ok = {"THJ1": 20, "THJ2": 18, "THJ3": 7.5, "THJ4": 65, "THJ5": 29,
            "FFJ0": 14, "FFJ3": 7, "FFJ4": -0.4,
            "MFJ0": 62, "MFJ3": 61, "MFJ4": 10,
...
rf_ok = {"THJ1": 17, "THJ2": 1, "THJ3": 15, "THJ4": 71, "THJ5": 53,
            "FFJ0": 14, "FFJ3": 7, "FFJ4": -0.4,
            "MFJ0": 45, "MFJ3": 4, "MFJ4": -1,
            "RFJ0": 85, "RFJ3": 42, "RFJ4": -19,
            "LFJ0": 30, "LFJ3": 0, "LFJ4": -12, "LFJ5": 7 }
# O.K. transition from ring finger to little finger
rf2lf_ok = {"THJ1": 2, "THJ2": -5, "THJ3": 8, "THJ4": 60, "THJ5": -22,
            "FFJ0": 14, "FFJ3": 7, "FFJ4": -0.4,
            "MFJ0": 45, "MFJ3": 4, "MFJ4": -1,
            "RFJ0": 30, "RFJ3": 6, "RFJ4": 0.5,
            "LFJ0": 30, "LFJ3": 0, "LFJ4": -10, "LFJ5": 7 }
# O.K. with little finger
lf_ok = {"THJ1": 21, "THJ2": 15, "THJ3": 10, "THJ4": 70, "THJ5": 15,
            "FFJ0": 14, "FFJ3": 7, "FFJ4": -0.4,
            "MFJ0": 15, "MFJ3": 4, "MFJ4": -1,
            "RFJ0": 15, "RFJ3": 6, "RFJ4": 0.5,
            "LFJ0": 53, "LFJ3": 43, "LFJ4": -13, "LFJ5": 43 }
# zero wrist
...
def secuence_ff():
   ...
   rospy.sleep(0.9)
   tmp = flex_th_2.copy()
   tmp.update({'interpolation_time': 1.5})
   c.move_hand(tmp)
   time_out = time.time() + 1.6
...
# c.move_hand(hand_pos)
   ...
   rospy.sleep(0.8)
   tmp = rf_ok.copy()
   tmp.update({'interpolation_time': 1.7})
   c.move_hand(tmp)
   time_out = time.time() + 1.9
