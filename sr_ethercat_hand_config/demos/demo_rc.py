...
pregrasp_pos = {"rh_THJ1": 5, "rh_THJ2": 0, "rh_THJ3": 0, "rh_THJ4": 60, "rh_THJ5": -18,
         "rh_FFJ1": 0, "rh_FFJ2": 25, "rh_FFJ3": 5, "rh_FFJ4": 12,
...
grasp_pos = {"rh_THJ1": 5, "rh_THJ2": 20, "rh_THJ3": 0, "rh_THJ4": 60, "rh_THJ5": 22,
         "rh_FFJ1": 0, "rh_FFJ2": 60, "rh_FFJ3": 55, "rh_FFJ4": 12,
         "rh_MFJ1": 0, "rh_MFJ2": 42, "rh_MFJ3": 33, "rh_MFJ4": 8,
         "rh_RFJ1": 0, "rh_RFJ2": 50, "rh_RFJ3": 18, "rh_RFJ4": -7,
         "rh_LFJ1": 0, "rh_LFJ2": 30, "rh_LFJ3": 0, "rh_LFJ4": -8, "rh_LFJ5": 7}
...
def secuence_lf():
    ...
    hand_commander.move_to_joint_value_target_unsafe(grasp_pos, 7.0, False, angle_degrees=True)
    offset1 = 0.18
 ...
 #       print("Hand joints position \n " + str(hand_pos) + "\n")	
        ...
        if (tactile_values['FF'] > force_zero['FF'] and trigger[0] == 0):
            ...
            hand_commander.move_to_joint_value_target_unsafe(hand_pos_incr_f, 0.5, False, angle_degrees=False)
...
#            trigger[3] = 1
        ...
        if (tactile_values['TH'] > force_zero['TH'] and trigger[4] == 0):
            ...
            hand_commander.move_to_joint_value_target_unsafe(hand_pos_incr_th, 0.5, False, angle_degrees=False)
            print 'Thumb contact'
            trigger[4] = 1
...
#                    trigger[3] == 1 and
    ...
    hand_pos = hand_commander.get_joints_position()
    hand_commander.move_to_joint_value_target_unsafe(hand_pos, 2.0, False, angle_degrees=False)
    rospy.sleep(2.0)
...
#                    "rh_LFJ3": hand_pos['rh_LFJ3'] + offset2, "rh_LFJ1": hand_pos['rh_LFJ1'] + offset2})
    ...
    hand_commander.move_to_joint_value_target_unsafe(squeeze, 0.5, False, angle_degrees=False)
    rospy.sleep(0.5)
    hand_commander.move_to_joint_value_target_unsafe(hand_pos, 0.5, False, angle_degrees=False)
    rospy.sleep(0.5)
    hand_commander.move_to_joint_value_target_unsafe(squeeze, 0.5, False, angle_degrees=False)
    rospy.sleep(0.5)
    hand_commander.move_to_joint_value_target_unsafe(hand_pos, 2.0, False, angle_degrees=False)
