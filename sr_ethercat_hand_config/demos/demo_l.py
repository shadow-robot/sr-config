...
rand_pos = {"lh_THJ2": 0, "lh_THJ3": 0, "lh_THJ4": 0, "lh_THJ5": 0,
            ...
            "lh_WRJ1": 0, "lh_WRJ2": 0}
# flex first finger
flex_ff = {"lh_FFJ1": 80, "lh_FFJ2": 80, "lh_FFJ3": 80, "lh_FFJ4": 0}
# extend first finger
ext_ff = {"lh_FFJ1": 0, "lh_FFJ2": 0, "lh_FFJ3": 0, "lh_FFJ4": 0}
# flex middle finger
flex_mf = {"lh_MFJ1": 80, "lh_MFJ2": 80, "lh_MFJ3": 80, "lh_MFJ4": 0}
# extend middle finger
ext_mf = {"lh_MFJ1": 0, "lh_MFJ2": 0, "lh_MFJ3": 0, "lh_MFJ4": 0}
# flex ring finger
flex_rf = {"lh_RFJ1": 80, "lh_RFJ2": 80, "lh_RFJ3": 80, "lh_RFJ4": 0}
# extend ring finger
ext_rf = {"lh_RFJ1": 0, "lh_RFJ2": 0, "lh_RFJ3": 0, "lh_RFJ4": 0}
# flex little finger
flex_lf = {"lh_LFJ1": 80, "lh_LFJ2": 80, "lh_LFJ3": 80, "lh_LFJ4": 0}
# extend middle finger
ext_lf = {"lh_LFJ1": 0, "lh_LFJ2": 0, "lh_LFJ3": 0, "lh_LFJ4": 0}
# flex thumb step 1
flex_th_1 = {"lh_THJ1": 0, "lh_THJ2": 0, "lh_THJ3": 0, "lh_THJ4": 70, "lh_THJ5": 0}
# flex thumb step 2
flex_th_2 = {"lh_THJ1": 35, "lh_THJ2": 38, "lh_THJ3": 10, "lh_THJ4": 70, "lh_THJ5": 47}
# extend thumb step 1
...
ff_ok = {"lh_THJ1": 36, "lh_THJ2": 11, "lh_THJ3": 0, "lh_THJ4": 53, "lh_THJ5": 14,
...
ff2mf_ok = {"lh_THJ1": 5, "lh_THJ2": 12, "lh_THJ3": 4, "lh_THJ4": 60, "lh_THJ5": 2,
            ...
            "lh_MFJ1": 0, "lh_MFJ2": 42, "lh_MFJ3": 33, "lh_MFJ4": 8,
            "lh_RFJ1": 0, "lh_RFJ2": 50, "lh_RFJ3": 18, "lh_RFJ4": -9,
            "lh_LFJ1": 0, "lh_LFJ2": 30, "lh_LFJ3": 0, "lh_LFJ4": -6, "lh_LFJ5": 7}
# O.K. with middle finger
mf_ok = {"lh_THJ1": 7, "lh_THJ2": 24, "lh_THJ3": 0, "lh_THJ4": 62, "lh_THJ5": 29,
         "lh_FFJ1": 0, "lh_FFJ2": 15, "lh_FFJ3": 7, "lh_FFJ4": -0.4,
         "lh_MFJ1": 5, "lh_MFJ2": 90, "lh_MFJ3": 24, "lh_MFJ4": 8,
         "lh_RFJ1": 0, "lh_RFJ2": 50, "lh_RFJ3": 18, "lh_RFJ4": -10,
         "lh_LFJ1": 0, "lh_LFJ2": 30, "lh_LFJ3": 0, "lh_LFJ4": -6, "lh_LFJ5": 7}
# O.K. transition from middle finger to ring finger
mf2rf_ok = {"lh_THJ1": 5, "lh_THJ2": -5, "lh_THJ3": 15, "lh_THJ4": 70, "lh_THJ5": 15,
            "lh_FFJ1": 0, "lh_FFJ2": 14, "lh_FFJ3": 7, "lh_FFJ4": -0.4,
            "lh_MFJ1": 0, "lh_MFJ2": 45, "lh_MFJ3": 4, "lh_MFJ4": -1,
            "lh_RFJ1": 0, "lh_RFJ2": 50, "lh_RFJ3": 18, "lh_RFJ4": -10,
            "lh_LFJ1": 0, "lh_LFJ2": 30, "lh_LFJ3": 0, "lh_LFJ4": -12, "lh_LFJ5": 7}
# O.K. with ring finger
rf_ok = {"lh_THJ1": 3, "lh_THJ2": 19, "lh_THJ3": 0, "lh_THJ4": 70, "lh_THJ5": 47,
         "lh_FFJ1": 0, "lh_FFJ2": 14, "lh_FFJ3": 7, "lh_FFJ4": -0.4,
         "lh_MFJ1": 0, "lh_MFJ2": 45, "lh_MFJ3": 4, "lh_MFJ4": -1,
         "lh_RFJ1": 3, "lh_RFJ2": 90, "lh_RFJ3": 28, "lh_RFJ4": -9,
         "lh_LFJ1": 0, "lh_LFJ2": 30, "lh_LFJ3": 0, "lh_LFJ4": -12, "lh_LFJ5": 7}
# O.K. transition from ring finger to little finger
rf2lf_ok = {"lh_THJ1": 5, "lh_THJ2": 4.5, "lh_THJ3": 8, "lh_THJ4": 60, "lh_THJ5": 17,
            "lh_FFJ1": 0, "lh_FFJ2": 14, "lh_FFJ3": 7, "lh_FFJ4": -0.4,
            "lh_MFJ1": 0, "lh_MFJ2": 45, "lh_MFJ3": 4, "lh_MFJ4": -1,
...
shake_grasp_1 = {"lh_THJ1": 0, "lh_THJ2": 6, "lh_THJ3": 10, "lh_THJ4": 37, "lh_THJ5": 9,
                 ...
                 "lh_LFJ1": 0, "lh_LFJ2": 30, "lh_LFJ3": 0, "lh_LFJ4": -10, "lh_LFJ5": 10}
# grasp for shaking hands step 2
shake_grasp_2 = {"lh_THJ1": 21, "lh_THJ2": 21, "lh_THJ3": 10, "lh_THJ4": 42, "lh_THJ5": 21,
                 ...
                 "lh_LFJ1": 10, "lh_LFJ2": 90, "lh_LFJ3": 41, "lh_LFJ4": 0, "lh_LFJ5": 0}
# store step 1 PST
...
def secuence_lf():
    ...
    squeeze.update({"lh_THJ5": hand_pos['lh_THJ5'] + offset2, "lh_THJ2": hand_pos['lh_THJ2'] + offset2,
                    ...
                    "lh_LFJ3": hand_pos['lh_LFJ3'] + offset2, "lh_LFJ1": hand_pos['lh_LFJ1'] + offset2})
